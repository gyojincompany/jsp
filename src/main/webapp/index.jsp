...
<body>
	...
	<form action="loginOk.jsp" method="post" name="loginForm">
		...
		PASSWORD : <input type="password" name="memberPw"><br><br>
		...
		<input type = "checkbox" name = "friend" value="강감찬"> 강감찬 <br><br>
		로그인여부 : <input type="radio" name="loginState" value="예">예 
		<input type="radio" name="loginState" value="아니오">아니오 <br><br>
		자동차 : 
		<select name="car">
		...
		<br><br>
		자기소개 : 
		<textarea rows="5" cols="40" name="intro">50자 이내로 작성</textarea>
		<br>
